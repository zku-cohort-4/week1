...
template sudoku() {
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            assert(rangeProofPuzzle[i][j].out); //[assignment] change assert() to use your created RangeProof instead 
            
            // RangeProof Solutions
            ...
            assert(rangeProofSolution[i][j].out); //[assignment] change assert() to use your created RangeProof instead
